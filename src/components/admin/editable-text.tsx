...
export function EditableText({
  ...
  return (
    <Tag
      ...
      className={`outline-none transition-all focus:bg-black/5 hover:bg-black/5 focus:ring-2 focus:ring-forest/20 rounded cursor-text min-h-[1.5em] min-w-[2ch] ${className}`}
