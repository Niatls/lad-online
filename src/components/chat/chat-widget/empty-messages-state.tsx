...
export function ChatWidgetEmptyMessages({
  visitorName,
  ...
  return (
    <div className="flex h-full select-none flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <h4 className="mb-2 text-xl font-bold text-forest">
        Здравствуйте, {visitorName || "друг"}!
      </h4>
      <p className="max-w-[240px] text-sm leading-relaxed text-forest/50">
        Мы рядом, если вам захочется задать вопрос. Напишите первое сообщение,
        и специалист подключится, как только освободится.
      </p>
    </div>
  );
}
